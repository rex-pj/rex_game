        ...
        Box::pin(async move {
            ...
            let existing = RolePermission::find()
                ...
                .columns([
                    ...
                    role_permission::Column::CreatedOn,
                    role_permission::Column::CreatedById,
                    role_permission::Column::UpdatedOn,
...
fn map_entity_to_model(entity: RolePermissionWithUser) -> RolePermissionModel {
    RolePermissionModel {
        ...
        created_on: entity.created_on.with_timezone(&Utc),
        updated_on: entity.updated_on.with_timezone(&Utc),
