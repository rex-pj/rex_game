      ...
      <div class="modal-content">
        <form onsubmit={handleSubmit}>
          <div class="modal-header">
            <h5 class="modal-title">Delete Flashcard Type</h5>
            <button
              type="button"
              class="btn-close"
              aria-label="Close delete flashcard type"
              onclick={closeModal}
            ></button>
          </div>
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <span>Do you want to delete the flashcard type: {$initialData.name}</span>
            </div>
          </div>
